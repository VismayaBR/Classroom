...
$staff_id    = $_GET['sc_id'];
$query_ret = mysqli_query($con, "SELECT * FROM tbl_officestaff JOIN tbl_login ON tbl_login.login_id=tbl_officestaff.login_id WHERE tbl_officestaff.login_id='$staff_id'");

$sem_data  = mysqli_fetch_assoc($query_ret);
if(isset($_POST['submit']))
{
  $staff_name = $_POST['s_name'];
  $username = $_POST['s_user'];
  $staff_email = $_POST['s_email'];
  $staff_address = $_POST['s_address'];
  $staff_mobile = $_POST['s_phone'];

$query_staff = mysqli_query($con, "UPDATE tbl_officestaff SET staff_name='$staff_name',staff_email='$staff_email',staff_address='$staff_address',staff_mob='$staff_mobile'WHERE login_id='$staff_id'");

$staff=mysqli_query($con,"UPDATE tbl_login SET username='$username' WHERE login_id='$staff_id'");
                        ...
                        <div class="form"  >
                            ...
                            <form method="post" align="left">
                                <div class="form-group">
                                    <label class="my-2">Eidt OfficeStaff</label>
                                    <span id="errname" style="color: red;"></span>
                                     <input class="form-control" type="text" name="s_name" value="<?php echo $sem_data['staff_name']; ?>" onkeyup="clear_validation_err('errname');" id="s_name"placeholder="Staff name" required="">
                                     <span id="errmail" style="color: red;"></span>
                                    <input class="form-control" type="text" name="s_email" value="<?php echo $sem_data['staff_email']; ?>"onkeyup="clear_validation_err('errmail');" id="s_email" placeholder="Email" required="">
                                    <span id="erradd" style="color: red;"></span>
                                    <input class="form-control" type="text" name="s_address" value="<?php echo $sem_data['staff_address']; ?>" onkeyup="clear_validation_err('erradd');" id="s_address"placeholder="Address" required="">
                                    <span id="errphn" style="color: red;"></span>
                                    <input class="form-control" type="text" name="s_phone" pattern="[1-9]{1}[0-9]{9}" value="<?php echo $sem_data['staff_mob']; ?>"onkeyup="clear_validation_err('errphn');" id="s_phone" placeholder="MobileNo" required="">
