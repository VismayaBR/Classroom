    ...
    <div class="banner1">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" href="teacher.php">WELCOME TO OUR COLLEGE
							<span> </span>
						</a></h1>
...
<table id="category_table" class="table table-bordered table-striped">
    <thead>
		...
		include "connect.php";
		$dpt_id = $_POST["dpt_id"];
       $username = mysqli_query($con, "SELECT * FROM pta_attendance JOIN tbl_student ON pta_attendance.department_id=tbl_student.department_id JOIN tbl_department ON tbl_department.department_id=pta_attendance.department_id JOIN tbl_sem ON tbl_sem.sem_id=pta_attendance.sem_id WHERE tbl_student.department_id ='$dpt_id'");
			...
			while ($row1=mysqli_fetch_array($username))
			 {
			 	...
			 	<tr> 
                  ...
                  <td align="center"><?php echo $row1['stud_guardian']; ?></td>
                  <td align="center"><?php echo $row1['p_date']; ?></td>
                  <td align="center"><?php echo $row1['p_attend']; ?></td>     
