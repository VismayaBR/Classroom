...
$t_query=mysqli_query($con,"SELECT * FROM tbl_parent WHERE login_id='$id'");
$row=mysqli_fetch_assoc($t_query);
$parent_id=$row['parent_id'];

$update_query=mysqli_query($con,"UPDATE tbl_reply SET seen=2 WHERE parent_id='$parent_id' ");
      ...
      <div class="container-fluid">
        ...
        <div class="card">
            ...
            <table id="category_table" class="table table-bordered table-striped">
                ...
                <?php
                $query_ret=mysqli_query($con,"SELECT * FROM tbl_message WHERE parent_id='$parent_id'");
                 $i = 0;
                ...
                <tr>
                  ...
                  <td align="center"><a href="rply_cmt.php?msg_id=<?php echo $data['msg_id']; ?>&parent_id=<?php echo $data['parent_id']; ?>&t_id=<?php echo $data['teacher_id']; ?>">Comments</a></td>     
