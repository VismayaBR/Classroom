...
<table id="category_table" class="table table-bordered table-striped">
	      	...
	      	$query_ret=mysqli_query($con,"select * from tbl_university join tbl_sem on tbl_sem.sem_id=tbl_university.sem_id where tbl_university.reg_no ='$reg' and tbl_university.sem_id='$sem'");
