...
$query=mysqli_query($con,"SELECT * FROM reply_tb"); 
...
if(isset($_POST['sub']))
{
  ...
  if($pic !="")
    ...
    mysqli_query($con,"INSERT INTO reply_tb (msg_id,name,rply,file) VALUES ('$details','$name','$reply','$filenew')");
...
function check_ext($f_ext)
      {
        $allowed= array('jpg','JPG','png','jpeg','PNG','pdf','docs');
...
<body>
    ...
    <div class="banner1">
               ...
               <h1><a class="navbar-brand" href="index.html">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="public.php">Back</a>
                                </li>
      ...
      <div class="container-fluid">
            ...
            <!-- /.card-header -->
            <div class="col-lg-8" id="frm" align="center">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form method="post" action="" enctype="multipart/form-data">
                                                             ...
                                                             <div class="row form-group">
                                                                 <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Your name</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" name="name" id="name" required=""> <span id="span_comment" style="color: red"></span></div>
                                                              </div>
                                                              ...
                                                              <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><textarea name="coments" onclick="clearerror('span_comment')" id="comments_id" rows="5" class="form-control"></textarea><span id="span_comment" style="color: red"></span></div>
                                                                 ...
                                                                 <div ><input type="file" name="f1"  id="name" >
                                                                 </div><br>
