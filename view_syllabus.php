...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <!-- <td align="center"><a href="edit_syll.php?sc_id=<?php echo $data['syllabus_id']; ?>">Edit</a> / <a href="delete_syll.php?sd_id=<?php echo $data['syllabus_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>  -->    
