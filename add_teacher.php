...
mysqli_query($con, "INSERT INTO tbl_login(username,password,role)VALUES('$t_user','$t_pwd','$role')");
$login_id = mysqli_insert_id($con);

$querys=mysqli_query($con, "INSERT INTO tbl_teacher(login_id,subject_id,t_name,t_email,t_address,t_phone,status_hod,status_ct) VALUES ('$login_id','$t_sub','$t_name','$t_email','$t_address','$t_phone','$status_hod','$status_ct')");
