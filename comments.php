...
$data=mysqli_query($con,"SELECT * FROM public_chat"); 
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tbody>
                     <?php $i = 0; while($dat = mysqli_fetch_assoc($data))
                {
                  $i++;
                ?>
                ...
                <tr>
                     <td align="center"><?php echo $i; ?></td>
                      <td align="center"><?php echo $dat['name']; ?></td>
                    <td align="center"><?php echo $dat['message']; ?></td>
                  
                     <th><a href="replycomment.php?edit_id=<?php echo $dat['msg_id'];?>"type="submit">reply and view comments</a></th>
