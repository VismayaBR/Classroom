...
$querys=mysqli_query($con, "INSERT INTO tbl_timetable(department,sem,forenoon_sub,forenoon_teacher,afternoon_sub,afternoon_teacher) VALUES ('$department','$sem','$forenoon_sub','$forenoon_teacher','$afternoon_sub','$afternoon_teacher')");
    ...
    <div class="banner4">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" href="index.php">TIME TABLE
							<span> </span>
						</a></h1>
