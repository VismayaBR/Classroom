...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_assignment WHERE name='$name'");
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"> <a href="delete_ass.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
