    ...
    <div class="banner6">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" >WELCOME TO OUR CLASSROOM
              <span> </span>
            </a></h1>
            ...
            <div class="banner-text">
                <div class="slider-info">
                    ...
                    <div class="col-md-12 main_grid_contact">
                        <div class="form">
                            <h4 class="mb-4 text-left">Submitt Assignment</h4>
                            <form  method="post" action="ass1.php" enctype="multipart/form-data">
                              <?php
                              include "connect.php";
                              ...
                              ?>
                               ...
                               <div class="form-group">
                                   <label class="col-form-label" for="inputDefault">Assignment</label>
