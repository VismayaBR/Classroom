...
$link=$_POST['link'];
                   ...
                   mysqli_query($con,"INSERT INTO tbl_youtube(department_id,sem_id,heading,link)VALUES ('$depart','$sem_id','$head','$link')");
    ...
    <div class="banner6">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" >YOUTUBE LINKS
            </a></h1>
            ...
            <div class="banner-text">
                <div class="slider-info">
                    ...
                    <div class="col-md-12 main_grid_contact">
                        <div class="form">
                            <h4 class="mb-4 text-left"> Upload Links</h4>
                ...
                ?>    
                   ...
                   <input type="text" name="heading" required>
                                ...
                                <div class="form-group">
                                   <label class="col-form-label" for="inputDefault">Upload Link</label>
