...
if(isset($_POST['sub']))
{
    ...
    mysqli_query($con,"INSERT INTO public_chat (name,message) VALUES ('$name','$msg')");

    echo "<script> alert('message is added');</script>";
   echo "<script> window.location.href='public.php'</script>";
