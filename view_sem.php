...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_sem");
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><a href="edit_sem.php?sc_id=<?php echo $data['sem_id']; ?>">Edit</a> / <a href="delete_sem.php?sd_id=<?php echo $data['sem_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
