...
$query_stud = mysqli_query($con, "SELECT * FROM tbl_student ");
                ...
                <div class="slider-info" align="LEFT">
                      <div class=" main_grid_contact" >
                        <div class="form"  >
                            ...
                            <form method="post" action="view_intern.php"align="left">
                                <div class="form-group">
                                    <label class="my-2">View Internal Marks</label>
                 ...
                 <div class="form-group">
                      ...
                      <option value="">Select RegisterNo</option>
                      <?php while($qData = mysqli_fetch_assoc($query_stud)) { ?>
                      <option value="<?php echo $qData['reg_no'] ?>"><?php echo $qData['reg_no']; ?></option>
                      <?php } ?>
                    </select>
                </div>
