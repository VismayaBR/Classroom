...
<table id="category_table" class="table table-bordered table-striped">
            ...
            $depart=$_POST['depart'];
	      	...
	      	$query_ret=mysqli_query($con,"select * from tbl_marks join tbl_department on tbl_department.department_id=tbl_marks.department_id join tbl_sem on tbl_sem.sem_id=tbl_marks.sem_id where tbl_marks.reg_no ='$reg' and tbl_marks.sem_id='$sem' and tbl_marks.department_id='$depart'");
