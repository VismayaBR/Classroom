...
<br><br><br><br><br><h1 align="left" class="form_studss"><font color="brown"></font></h1></br>
...
<table id="category_table" class="table table-bordered table-striped">
    <thead>
		...
		$dpt_id = $_POST["depart"];
    $sem_id = $_POST["sem_id"];
       $username = mysqli_query($con, "SELECT * FROM tbl_material  WHERE department_id ='$dpt_id' AND sem_id='$sem_id'");
			...
			while ($row1=mysqli_fetch_array($username))
			 {
			 	...
			 	<tr> 
                  ...
                  <td align="center"><?php echo $row1['file']; ?></td>
                  <td align="center"><a style="color:blue; "download href="material/<?php echo $row1['file'];?>"> download </a> </td>
