...
if(!isset($_SESSION['login_id']))
{
 ...
 $sem_id=$row['sem_id'];
 $query1=mysqli_query($con, "SELECT * FROM tbl_sem WHERE sem_id='$sem_id'");
 $row1=mysqli_fetch_array($query1);
 $sem=$row1['sem'];
$query_ret = mysqli_query($con, "SELECT * FROM tbl_assignment WHERE sem='$sem'");
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="text-align: center;">ASSIGNMRNT</th>
                ...
                <tr>
                  ...
                  <td align="center"> <a href="sub_ass.php?id=<?php echo $data['id']; ?>">Submitt here</a></td>     
