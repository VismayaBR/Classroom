...
$query_categ = mysqli_query($con, "INSERT INTO tbl_feedback(login_id,feedback,reply)VALUES('$id','$feedback','$reply')");
    ...
    <div class="banner4">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" href="student.php">FEEDBACK
							<span> </span>
						</a></h1>
                        ...
                        <div class="form"  >
                            ...
                            <form method="post" align="left">
                                <div class="form-group">
                                    <label class="my-2">Add Feedback</label>
                                    <input class="form-control" type="text" name="feedback" placeholder="Feedback" required="">
                                </div>
