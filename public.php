...
<body>
 ...
 -->
								...
								<!-- <li class="nav-item dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="add_message.php">Add message</a>
								...
								<li class="nav-item">
									<a class="nav-link" href="vw_studymateriels.php">Study_materiels</a>
								</li> -->
								<li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="banner-text">
            	<a href="add_message.php" class="banner-button111 btn mt-md-5 mt-4">Any Doubts?? <br> Then ASK! </a>
                    ...
                    <a href="vw_studymateriels.php" class="banner-button112 btn mt-md-5 mt-4">Study Meterials </a>
                    &nbsp&nbsp
<div> <a href="comments.php" class="banner-button110 btn mt-md-5 mt-4">View and answer Doubts ?  </a>
                    &nbsp&nbsp
