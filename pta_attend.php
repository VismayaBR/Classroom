    ...
    <div class="banner1">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" href="hod.php">WELCOME TO OUR COLLEGE
							<span> </span>
						</a></h1>
...
<br><br><br><br><br><h1 align="left" class="form_studss"><font color="brown">Attendance</font></h1></br>
    ...
    <form action="pta_attend2.php" method="post">
   <div class="row">
			...
			while ($row1=mysqli_fetch_array($username))
			 {
			 	...
			 	<tr>
                        ...
                        <td align="center"><font color="black" size="4" style="float: center"class="stud"  >
                        <input type="text" name="guard[]" value="<?php echo $row1[10];?>" readonly>
			 			<td align="center"><font color="black" size="4" style="float: center"class="stud" >
