...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_librarian JOIN login_tb ON login_tb.login_id=tbl_librarian.login_id ");
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><?php echo $data['lib_name']; ?></td>
                  <td align="center"><?php echo $data['lib_email']; ?></td>
                  <td align="center"><?php echo $data['lib_phone']; ?></td>
                  <td align="center"><?php echo $data['lib_address']; ?></td>
                  <td align="center"><?php echo $data['username']; ?></td>
                  <td align="center"><a href="edit_lib.php?sc_id=<?php echo $data['login_id']; ?>">Edit</a> / <a href="delete_lib.php?sd_id=<?php echo $data['login_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
