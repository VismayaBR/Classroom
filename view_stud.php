...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_student JOIN tbl_login ON tbl_login.login_id=tbl_student.login_id JOIN tbl_department ON tbl_department.department_id=tbl_student.department_id JOIN tbl_sem ON tbl_sem.sem_id =tbl_student.sem_id ");
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
								<li class="nav-item active">
									<a class="nav-link" href="teacher.php">BACK
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><a href="edit_stud.php?sc_id=<?php echo $data['login_id']; ?>">Edit</a> / <a href="delete_stud.php?sd_id=<?php echo $data['login_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
