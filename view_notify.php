...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_notification ");
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><a href="edit_noti.php?sc_id=<?php echo $data['notify_id']; ?>">Edit</a> / <a href="delete_noti.php?sd_id=<?php echo $data['notify_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
