...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_material JOIN tbl_department ON tbl_material.department_id=tbl_department.department_id JOIN tbl_sem ON tbl_material.sem_id=tbl_sem.sem_id");
...
<table id="category_table" class="table table-bordered table-striped">
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td align="center"><?php echo $data['heading']; ?></td>
                  <td align="center"><a href="<?php echo $data['file_path']; ?>" target="_thapa">Download</a> </td>     
