...
$query=mysqli_query($con, "INSERT INTO tbl_digitalnotice(subject,description,upload_date) VALUES ('$sub','$description','$up_date')");
                        ...
                        <div class="form"  >
                            ...
                            <form method="post" align="left">
                                <div class="form-group">
                                    <label class="my-2">Add Notice</label>
                                    ...
                                    <input class="form-control" type="date" name="up_date" placeholder="Date" required="">
