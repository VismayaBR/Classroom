    ...
    <div class="banner1">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" href="student.php">WELCOME TO OUR COLLEGE
							<span> </span>
						</a></h1>
    ...
    <thead>
               <tr>
                  ...
                  <th style="text-align: center;">Attendance</th>
							...
							<?php
		include "connect.php";
       $username = mysqli_query($con, "SELECT * FROM attendance JOIN tbl_department ON tbl_department.department_id=attendance.department_id JOIN tbl_sem ON tbl_sem.sem_id=attendance.sem_id WHERE attendance.department_id ='$depart' AND attendance.reg_no='$reg'");
