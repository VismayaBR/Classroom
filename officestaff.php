                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="view_students_p.php">Add Parents</a> 
										<a class="dropdown-item" href="view_parents.php">View Parents</a>
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown">
										<a class="dropdown-item" href="add_lib.php">Add Librarian</a>
										<a class="dropdown-item" href="view_lib.php">View Librarian</a>
										<div class="dropdown-divider"></div>
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown">
										...
										<a class="dropdown-item" href="view_member.php">View Member</a>
										<div class="dropdown-divider"></div>
