...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_youtube JOIN tbl_department ON tbl_youtube.department_id=tbl_department.department_id JOIN tbl_sem ON tbl_youtube.sem_id=tbl_sem.sem_id");
...
<table id="category_table" class="table table-bordered table-striped">
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td align="center"><a href="<?php echo $data['link']; ?>"><?php echo $data['link']; ?></a></td>
