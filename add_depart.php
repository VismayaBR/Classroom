...
$query_categ = mysqli_query($con, "INSERT INTO tbl_department(dpt_name)VALUES('$depart')");
echo "<script>alert('Department added successfully!');</script>";
echo "<script>window.location.href='view_depart.php';</script>";}
?>
<!DOCTYPE html>
<html lang="zxx">
    ...
    <div class="banner4">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" href="index.php">DEPARTMENT
							<span> </span>
						</a></h1>
                        ...
                        <div class="form"  >
                            ...
                            <form method="post" align="left">
                                <div class="form-group">
                                    <label class="my-2">Add Department</label>
                                    <input class="form-control" type="text" name="depart" placeholder="" required="">
                                </div>
