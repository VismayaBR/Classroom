                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
								<li class="nav-item active">
									<a class="nav-link" href="officestaff.php">Home
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><a href="edit_teacher.php?sc_id=<?php echo $data['login_id']; ?>">Edit</a> / <a href="delete_teacher.php?sd_id=<?php echo $data['login_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
