    ...
    <div class="banner6">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
               <h1><a class="navbar-brand" >ASSIGNMENT
              <span> </span>
            </a></h1>
            ...
            <div class="banner-text">
                <div class="slider-info">
                    ...
                    <div class="col-md-12 main_grid_contact">
                        <div class="form">
                            <h4 class="mb-4 text-left">Add Assignment</h4>
                ...
                {
                     echo "<option value='". $row['dpt_name'] ."'>" .$row['dpt_name'] ."</option>" ;
                }
                ...
                ?>    
                   ...
                   <input type="text" name="subject" required>
                               ...
                               <div class="form-group">
                                   <label class="col-form-label" for="inputDefault">Assignment details</label>
