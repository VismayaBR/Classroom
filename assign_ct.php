...
$query_categ = mysqli_query($con, "INSERT INTO tbl_ct(login_id,department_id)VALUES('$id_id','$department')");

$query_status = mysqli_query($con, "UPDATE tbl_teacher SET status_ct='1' WHERE login_id='$id_id'");
                        ...
                        <div class="form"  >
                            ...
                            <form method="post" align="left">
                                <div class="form-group">
                                    <label class="my-2">Asign CT</label>
