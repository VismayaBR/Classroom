            ...
            <div class="banner-text">
                <div class="slider-info">
                    ...
                    <div class="col-md-12 main_grid_contact">
                        <div class="form">
                            <h4 class="mb-4 text-left">ATTENDANCE</h4>
                            <form action="vw_attend.php" method="post">
           ...
           <select name="sem_id"  id="sem" class="form-control" style="width:300px;margin-left: 26px;">
                      ...
                      <?php } ?>
                              ...
                              <br><br><div class="input-group1">
                                    <input class="form-control" type="submit" name="submit" value="Submit"><a href="vw_attend.php"></a>
                                </div></br>
