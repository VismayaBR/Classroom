...
<table id="category_table" class="table table-bordered table-striped">
    <thead>
		...
		$dpt_id = $_POST["depart"];
    $sem_id = $_POST["sem_id"];
       $username = mysqli_query($con, "SELECT * FROM attendance JOIN tbl_student ON attendance.department_id=tbl_student.department_id JOIN tbl_department ON tbl_department.department_id=attendance.department_id JOIN tbl_sem ON tbl_sem.sem_id=attendance.sem_id WHERE attendance.department_id ='$dpt_id' AND attendance.sem_id='$sem_id'");
			...
			while ($row1=mysqli_fetch_array($username))
			 {
			 	...
			 	<tr> 
                  ...
                  <td align="center"><?php echo $row1['subject']; ?></td>
