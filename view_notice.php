...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_digitalnotice");
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><a href="edit_notice.php?sc_id=<?php echo $data['notice_id']; ?>">Edit</a> / <a href="delete_notice.php?sd_id=<?php echo $data['notice_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
