...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_union JOIN tbl_login ON tbl_login.login_id=tbl_union.login_id");
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><?php echo $data['u_name']; ?></td>
                  <td align="center"><?php echo $data['u_email']; ?></td>
                  <td align="center"><?php echo $data['u_phn']; ?></td>
                  <td align="center"><?php echo $data['u_address']; ?></td>
                  <td align="center"><?php echo $data['username']; ?></td>
                  <td align="center"><a href="edit_member.php?sc_id=<?php echo $data['login_id']; ?>">Edit</a> / <a href="delete_member.php?sd_id=<?php echo $data['login_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
