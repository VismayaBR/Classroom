...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_semsubject JOIN tbl_department ON tbl_department.department_id=tbl_semsubject.department_id JOIN tbl_sem on tbl_sem.sem_id=tbl_semsubject.sem_id");
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="text-align: center;">Sub3</th>
                  <th style="text-align: center;">Sub4</th>
                  <th style="text-align: center;">Sub5</th>
                  <th style="text-align: center;">Sub6</th>
