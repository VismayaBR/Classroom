...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_programme");
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
								<li class="nav-item active">
									<a class="nav-link" href="union.php">Home
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="text-align: center;">Programme Date</th>
                ...
                <tr>
                  ...
                  <td align="center"><a href="edit_programme.php?sc_id=<?php echo $data['programme_id']; ?>">Edit</a> / <a href="delete_programme.php?sd_id=<?php echo $data['programme_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
