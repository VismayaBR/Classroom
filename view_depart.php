...
$query_ret = mysqli_query($con, "SELECT * FROM tbl_department");
...
<table id="category_table" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td align="center"><a href="edit_depart.php?sc_id=<?php echo $data['department_id']; ?>">Edit</a> / <a href="delete_depart.php?sd_id=<?php echo $data['department_id']; ?>" onclick="return confirm('Do you want to delete?');" >Delete</a></td>     
